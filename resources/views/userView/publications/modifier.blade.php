...
<div class="bg-lg-white text-warning py-lg-5 text-center">
    <div class="">
        <div class="">
            <h3 class="mt-4" style="color: orange" >MODIFIER UNE PUBLICATION</h3>
        </div>
    </div>
</div>
<div class="">
    <div class="">
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body">
                        <form method="post" action="{{ route('publier.edit.save') }}" enctype="multipart/form-data" >
                            @csrf
                            <input type="hidden" name="idPub" value="{{$data->id}}" >
                            <div class="px-lg-5 px-3 py-3" >
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="description_pub" id="" cols="30" rows="10" class="form-control">
                                        {{ @old('description_pub',$data->description_pub) }}
                                    </textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    @if($data->with_plan == 1) @php $aff ="" ; $che1 ="checked" ; $che2 = ""; @endphp @endif
