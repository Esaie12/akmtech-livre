...
@section('contenu')
<div class="card-body">
    <p class="text-center py-2">CONNECTEZ VOUS MAINTENANT</p>
    <form class="mb-3" id="loginForm" action="{{route('login')}}" method="post">
        @csrf
        ...
        <button class="btn btn-block btn-success mt-3" type="submit">Se connecter</button>
    </form>
